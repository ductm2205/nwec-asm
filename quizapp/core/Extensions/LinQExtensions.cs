...
public static class LinQExtensions
{
    ...
    public static IQueryable<T> CaseInsensitiveContains<T>(
    ...
    )
    {
        ...
        foreach (var property in properties)
        {
            ...
            {
                var lowerProperty = Expression.Call(member, toLowerMethod);
                var constant = Expression.Constant(keywordLower, typeof(string));
                var containsExpression = Expression.Call(lowerProperty, containsMethod, constant);
    ...
    public static IQueryable<T> GetPaginatedQuery<T>(
        this IQueryable<T> query,
        int pageNumber,
        int pageSize
    )
